...
export default function Login() {
  ...
  const handleLogin = async () => {
    try {
      ...
      const result = await ngoLogin(username, password);
    ...
    <div className="grid grid-cols-1 h-screen  md:grid-cols-2">
      ...
      <div className="relative hidden  flex-1 lg:block bg-[#F48547]">
        <div className="flex flex-col w-full h-full gap-6 justify-center items-center text-white">
          <Image src="/logo.jpeg" className="" alt="logo" width={45} height={45}/>
            ...
            <form action="#" method="POST" className="space-y-6">
              ...
              <div>
                <button
                  ...
                  type="button"
                  disabled={loading}
                  className="flex justify-center rounded-md border border-transparent bg-[#FD620B] py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-[#c8855e] focus:outline-none focus:ring-2 focus:ring-[#876754] focus:ring-offset-2"
                >
